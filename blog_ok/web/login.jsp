...
<div class="login-box">
	...
	<form action="login" method="POST" id="loginForm" novalidate>
		<div class="name">
			<label>账  号：</label>
			<input type="text" name="username" id="username" tabindex="1" autocomplete="off" required
				   value="${cookie.loginUsername.value}"
				   data-validation-required-message="账号不能为空" />
		</div>
		<div class="password">
			<label>密  码：</label>
			<input type="password" name="password" maxlength="16" id="password" tabindex="2" required
				   data-validation-required-message="密码不能为空" />
		</div>
		<div class="code">
			<label>验证码：</label>
			<input type="text" name="code" id="code" tabindex="3"/>
			<div class="codeImg">
				<img src="kaptcha.jpg"/>
			</div>
		</div>
...
<div class="screenbg">
	<ul>
		<li><a href="javascript:;"><img src="img/Dabab.jpg"></a></li>
		<li><a href="javascript:;"><img src="img/abab.png"></a></li>
	</ul>
</div>
